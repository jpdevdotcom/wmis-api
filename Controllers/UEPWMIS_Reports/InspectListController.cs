...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class InspectListController : Controller, IReportController
    {
        ...
        public InspectListController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\InspectCheckList.rdl", FileMode.Open, FileAccess.Read);
