...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class IAR_ReportController : Controller, IReportController
    {
        ...
        public IAR_ReportController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\IAR.rdl", FileMode.Open, FileAccess.Read);
