...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class Monthly_ReportController : Controller, IReportController
    {
        ...
        public Monthly_ReportController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\MonthlyReport.rdl", FileMode.Open, FileAccess.Read);
