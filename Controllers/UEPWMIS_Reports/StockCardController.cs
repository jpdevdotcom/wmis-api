...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class StockCardController : Controller, IReportController
    {
        ...
        public StockCardController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\StockCard.rdl", FileMode.Open, FileAccess.Read);
