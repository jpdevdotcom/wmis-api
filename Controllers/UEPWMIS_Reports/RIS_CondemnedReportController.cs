...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class RIS_CondemnedReportController : Controller, IReportController
    {
        ...
        public RIS_CondemnedReportController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\CondemnedReports\RIS_Condemned.rdl", FileMode.Open, FileAccess.Read);
