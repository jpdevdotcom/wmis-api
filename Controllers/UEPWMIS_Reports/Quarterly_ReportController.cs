...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class Quarterly_ReportController : Controller, IReportController
    {
        ...
        public Quarterly_ReportController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\Quarterly Report.rdl", FileMode.Open, FileAccess.Read);
