...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class PAR_CondemnedReportController : Controller, IReportController
    {
        ...
        public PAR_CondemnedReportController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\CondemnedReports\PAR_Condemned.rdl", FileMode.Open, FileAccess.Read);
