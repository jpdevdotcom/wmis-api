...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class RIS_ReportController : Controller, IReportController
    {
        ...
        public RIS_ReportController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\RIS.rdl", FileMode.Open, FileAccess.Read);
