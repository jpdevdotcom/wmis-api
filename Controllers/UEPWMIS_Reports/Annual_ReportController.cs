...
namespace UEPWarehouse_API.Controllers.UEPWMIS_Reports
{
    ...
    public class Annual_ReportController : Controller, IReportController
    {
        ...
        public Annual_ReportController(Microsoft.Extensions.Caching.Memory.IMemoryCache memoryCache,
        ...
        public void OnInitReportOptions(ReportViewerOptions reportOption)
        {
            ...
            FileStream reportStream = new FileStream(basePath + @"\ReportDesign\AnnualReport.rdl", FileMode.Open, FileAccess.Read);
